...
This sample module contains one small method that filters contigs.
    ...
    def run_rohansachContigFilter(self, ctx, params):
        """
        ...
        #BEGIN run_rohansachContigFilter

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_rohansachContigFilter function. Params=' + pformat(params))
        ...
        try: 
            ...
            raise ValueError('Cannot parse integer from min_length parameter (' + str(max_length_orig) + ')')
        if min_length > max_length:
            raise ValueError('Parameter min_length is greater than max_length')
        ...
        #END run_rohansachContigFilter

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_rohansachContigFilter return value ' +
                             'output is not type dict as required.')
        # return the results
        return [output]

    def run_rohansachContigFilter_max(self, ctx, params):
        """
        ...
        # ctx is the context object
        # return variables are: output
        #BEGIN run_rohansachContigFilter_max
        ...
        #END run_rohansachContigFilter_max

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_rohansachContigFilter_max return value ' +
                             'output is not type dict as required.')
        # return the results
        return [output]
    def status(self, ctx):
