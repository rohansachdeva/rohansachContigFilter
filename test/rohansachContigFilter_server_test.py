...
from rohansachContigFilter.rohansachContigFilterImpl import rohansachContigFilter
from rohansachContigFilter.rohansachContigFilterServer import MethodContext
...
class rohansachContigFilterTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('rohansachContigFilter'):
        ...
        cls.serviceImpl = rohansachContigFilter(cls.cfg)
    ...
    # NOTE: According to Python unittest naming rules test method names should start from 'test'. # noqa
    def test_run_rohansachContigFilter_ok(self):
        # call your implementation
        ret = self.serviceImpl.run_rohansachContigFilter(self.ctx,
    ...
    def test_run_rohansachContigFilter_min_len_negative(self):
        with self.assertRaisesRegex(ValueError, 'min_length parameter cannot be negative'):
            self.serviceImpl.run_rohansachContigFilter(self.ctx,
                                              {'workspace_name': self.wsName,
                                               'assembly_input_ref': '1/fake/3',
                                               'min_length': '-10'})

    def test_run_rohansachContigFilter_min_len_parse(self):
        with self.assertRaisesRegex(ValueError, 'Cannot parse integer from min_length parameter'):
            self.serviceImpl.run_rohansachContigFilter(self.ctx,
                                              {'workspace_name': self.wsName,
                                               'assembly_input_ref': '1/fake/3',
                                               'min_length': 'ten'})
    def test_run_rohansachContigFilter_max(self):
        ref = "79/16/1"
    ...
    def test_run_rohansachContigFilter_test_min(self):
        ref = "79/16/1"
        params = {
            'workspace_name': self.wsName,
            'assembly_ref': ref,
    ...
    def test_run_rohansachContigFilter_test_max(self):
        ref = "79/16/1"
        params = {
            'workspace_name': self.wsName,
            'assembly_ref': ref,
